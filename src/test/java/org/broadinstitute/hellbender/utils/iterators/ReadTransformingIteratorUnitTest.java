...
public class ReadTransformingIteratorUnitTest {

    private static List<GATKRead> READS = Arrays.asList(
    ...
    private static List<Integer> READ_CIGAR_SIZES = Arrays.asList(3,1,3,2,1);
