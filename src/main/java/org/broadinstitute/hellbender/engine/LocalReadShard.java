...
public final class LocalReadShard implements Shard<GATKRead> {
    ...
    /**
     * Reads in this shard will be transformed after filtering and downsampling
     *
     * @param transformer read transformer to apply after read filtering and after downsampling
     */
